						...
						<div className='container'>
                          ...
                          <span class="review-count">6 reviews</span>
								...
								<div className='col-lg-9 col-md-12 col-sm-12'>
									...
									<div className='row'>
										{sp_brand.map((th) => (
											<div className='col-lg-4 col-md-4 col-6' key={th.id}>
												<div
												...
												>
													<div className='inner-item-pro'>
														<div className='img-hvr pos-re'>
															<a href='/mat-ong-bo-de-hoa/mat-ong-bo-de-hoa-goi-10g.html'>
																<img src={`${th.hinh}`} width='100%' alt='Mật ong Bồ đề hoa gói 10g' />
															</a>
															{/*<a class="fav-icon" href="#"></a>*/}
														</div>
														<div className='content-item-pro ih'>
															<h3 className='pro-item-name'>
																<Link to={`/Detail/${th.id}`}>{th.tensp}</Link>
															</h3>
															...
															<a href='#!' onClick={addToCart.bind(this, th.id, th.gia)} className='btn-detail-pro'>
										...
										<div className='paging'>
											<ul className='pagination justify-content-center'>
												...
												<li className='page-item'>
													<a className='page-link active' href='true'>
														&nbsp;<span>1</span>&nbsp;
													</a>
												</li>
												<li className='page-item'>
